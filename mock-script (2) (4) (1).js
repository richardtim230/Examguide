...
function startExam(examId, examTitle) {
    console.log(`Starting exam: ${examTitle || examId}`); // Debugging log

    // Store the selected exam for later use, using the course code as the title if no title is provided

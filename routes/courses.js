  ...
  try {
    ...
    const [courses, total] = await Promise.all([
      Course.find(filter)
        ...
        .skip((pg - 1) * lim)
        .limit(lim)
        .select("title slug description level faculty department booksCount imageUrl cover rewardPoints minimumReadTime tags createdAt")
        .lean(),
    ...
    console.error("GET /api/courses/public error:", err);
